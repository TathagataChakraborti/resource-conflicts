(define
	...
	(:action EXPLAIN_OBS_MOVE_HUMAN_ROOM5_HALL1_1
		...
		(and
			...
			( AT_HUMAN_HALL1 )
			 ...
			 ( EXPLAINED_FULL_OBS_SEQUENCE )
			(not ( AT_HUMAN_ROOM5 ))
			 (not ( NOT_EXPLAINED_MOVE_HUMAN_ROOM5_HALL1_1 ))
	...
	(:action MOVE_REVERSE_HUMAN_HALL1_ROOM5
		:parameters ()
		:precondition
		(and
			( AT_HUMAN_HALL1 )
